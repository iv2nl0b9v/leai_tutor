...
def test_proper_session_update_pattern():
    ...
    new_messages = current_session.value.messages + [asdict(student_msg), asdict(tutor_msg)]
...
@pytest.mark.xfail(reason="Demonstrates the bug that was fixed - mutating then reassigning doesn't work properly")
